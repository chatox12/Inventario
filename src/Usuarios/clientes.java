...
public class clientes extends javax.swing.JInternalFrame {
    ...
    {
        String[]titulos={"No","Nombre","NIT","Telefono","Direccion"} ;  
        String []Registros= new String[5];
        modelo=new DefaultTableModel(null,titulos);
        String Sql="SELECT * FROM Clientes WHERE CONCAT(cli_nombre,cli_nit) LIKE '%"+valor+"%'";
        ...
        try {
             ...
             while(rs.next())
             {
                 ...
                 Registros[2]=rs.getString("cli_nit");  
...
// TODO add your handling code here:
    ...
    try {
        ...
        else
        {
         ...
         Nit =  (String)tbclientes.getValueAt(fila, 2);       
...
// TODO add your handling code here:
    try {
        cliente ingcli= new cliente();
        Administrador.Escritorio.add(ingcli);
        ingcli.toFront();
