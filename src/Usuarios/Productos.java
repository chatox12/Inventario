...
public class Productos extends javax.swing.JInternalFrame {
     ...
     String comparar(String cod)
    {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM productos WHERE pro_codigo='"+cod+"'");
            while(rs.next())
            {
                cant=rs.getString(3);
            }
    ...
    String mostrar="SELECT * FROM productos WHERE CONCAT (pro_codigo,'',pro_nombre) LIKE '%"+dato+"%'"; 
    Statement st;
        try {
            ...
            while(rs.next())
            {
                ...
                Registro[2]=rs.getString("pro_precioVenta");
                Registro[3]=rs.getString("pro_stock");
...
// TODO add your handling code here:
    ...
    try {
         ...
         if(fila==-1)
         {
          ...
          String cantidad = tbprod.getValueAt(fila,3).toString();
          int c=0;
          int j=0;
